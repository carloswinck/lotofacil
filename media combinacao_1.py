...
# Contar a frequência das combinações de números primos, Fibonacci e múltiplos de 3
...
for linha in linhas:
    ...
    combinacoes = combinations(primos + fibonacci + multiplos_de_3, 8)
...
print(f'A combinação de números primos, Fibonacci e múltiplos de 3 que mais aparece é: {combinacao_mais_frequente[0]} com {combinacao_mais_frequente[1]} ocorrências')